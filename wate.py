...
class Main:
    def __init__(self,start,end,surface):
        ...
        self.init_position_x = start ## first position
        self.final_position_x = end ## second_position
...
class Spring:
    ...
    def draw(self, screen):
        ...
        pygame.draw.line(screen, (66, 209, 252), (self.x, self.height), (self.x, self.bottom), self.rod_width)
